...
let AgentDetailComponent = (() => {
    ...
    let _classThis;
    var AgentDetailComponent = _classThis = class {
        ...
        get filteredAgentsForMovement() {
            ...
            return this.agent.agents.filter(sub => sub.firstName.toLowerCase().includes(term) ||
        ...
        get filteredDeposits() {
            ...
            return this.agent.deposits.filter(d => d.agentName.toLowerCase().includes(term) ||

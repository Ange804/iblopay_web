...
export class CardService {
  ...
  activateCard(cardId: string): Observable<Card> {
    return this.http.patch<Card>(`${this.baseUrl}/${cardId}/activate`, {});
  }

  blockCard(cardId: string, reason?: string): Observable<Card> {
    return this.http.patch<Card>(`${this.baseUrl}/${cardId}/block`, { reason });
  }

  replaceCard(cardId: string): Observable<Card> {
    return this.http.post<Card>(`${this.baseUrl}/${cardId}/replace`, {});
  }
